...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Victim Services & Support Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Victim Case Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "victim_case_record_records";
'use strict';
